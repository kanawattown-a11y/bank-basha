...
export default function AdminDashboard() {
    ...
    const sidebarItems = [
        ...
        { id: 'password-requests', icon: ShieldExclamationIcon, label: 'طلبات استعادة كلمة المرور', link: '/admin/password-requests' },
        { id: 'exchange-rates', icon: BanknotesIcon, label: 'أسعار الصرف', link: '/admin/exchange-rates' },
