                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mb-6">
                        <input
                            ...
                            placeholder="🔍 ابحث عن مزود خدمة أو محل..."
                    ...
                    {categories.length === 0 ? (
                        ...
                        <div className="space-y-8">
                            {categories.map((category) => {
                                ...
                                // Filter services by search query (seller name)
                                const filteredServices = searchQuery.trim()
                                    ? category.services.filter((service) => {
                                        const sellerName = service.seller?.fullName?.toLowerCase() || '';
                                        const sellerNameAr = service.seller?.fullNameAr?.toLowerCase() || '';
                                        const serviceName = (service.nameAr || service.name || '').toLowerCase();
                                        const query = searchQuery.toLowerCase();
                                        return sellerName.includes(query) || sellerNameAr.includes(query) || serviceName.includes(query);
                                    })
                                    : category.services;
                                                        ...
                                                        <div className="relative h-28 bg-dark-800 overflow-hidden">
                                                            <img
                                                                ...
                                                                onError={(e) => {
                                                                    ...
                                                                    if (parent) {
                                                                        parent.classList.add('flex', 'items-center', 'justify-center', 'bg-gradient-to-br', 'from-primary-500/20', 'via-dark-800', 'to-dark-900');
                                                                    }
                                                                }}
                                                            />
                                                        ...
                                                        {service.seller && (
                                                            <div className="flex items-center gap-2 mb-2 text-xs">
                                                                ...
                                                                <span className="text-dark-300">
                                                                    {service.seller.fullNameAr || service.seller.fullName}
                                                                </span>
                                                                {service.providerLocation && (
                                                                    <>
                                                                        <span className="text-dark-600">•</span>
                                                                        <span className="text-dark-400">📍 {service.providerLocation}</span>
                                                                    </>
                                                                )}
                                                            </div>
                                                        )}
